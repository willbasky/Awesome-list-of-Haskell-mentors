...
| [Sridhar Ratnakumar](https://github.com/srid) | [Ema](https://ema.srid.ca/) and [Emanote](https://github.com/srid/emanote): Note-taking; Pandoc; Static site generation; Nix | [![Matrix](https://img.shields.io/matrix/ema:matrix.org.svg?label=chat%20on%20Matrix&logo=matrix&server_fqdn=matrix.org)](https://matrix.to/#/#ema:matrix.org)
