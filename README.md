...
| [Sridhar Ratnakumar](https://github.com/srid) | [Ema](https://ema.srid.ca/) and [Emanote](https://github.com/srid/emanote): Note-taking; Pandoc AST; Static site generation; Graph data structure; Nix | [matrix](https://matrix.to/#/#neuron:matrix.org) or <srid@srid.ca>
